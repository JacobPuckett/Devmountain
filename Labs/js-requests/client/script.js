...
// CODE HERE
    ...
    // sayHelloButton = document.getElementById("say-hello-button").style.backgroundColor = '#000000';
    // sayHelloButton = document.getElementById("say-hello-button").style.color = '#ffffff'
...
const repeatMyParam = () => {
    axios.get(`http://localhost:3000/repeat/JACOB`)
    .then(response => {
...
// CODE HERE
let request = evt => {
    axios.get('http://localhost:3000/query-test?lions=big')
    .then(response =>{
        console.log(response.data)
    })
