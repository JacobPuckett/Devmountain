...
console.log(totalPopulation(tax))
...
// let jacob = new uUser('Brayn G. Smith', 'bryan.smith@devmounta.in')
...
let jpuck = new Wizard('jpuck', 23, 'fireball')
console.log(jpuck)
jpuck.castSpell(2)
...
//Code Here
let phone = new Phone('Iphone',10, '124g', 'red', 500)
let phoneTwo = new Phone('Iphone',10, '124g', 'green', 600)
let phoneThree = new Phone('Iphone',10, '124g', 'blue', 700)
