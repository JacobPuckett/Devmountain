...
let numsCnt = fujiAcres.length

let averageDailyAcres = totalAcres / numsCnt
...
// CODE HERE
while (acresLeft > 0){ // it will stop once acresleft reaches 0
    acresLeft -= averageDailyAcres // this will -9 from 174 per loop
    days += 1
    // will add 1 day per loop
}
...
// CODE HERE
fujiPounds = fujiPounds * fujiPrice
galaPounds = galaPounds * galaPrice
pinkPounds = pinkPounds * pinkPrice
